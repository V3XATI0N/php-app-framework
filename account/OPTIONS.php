            ...
            if (!empty($plugins[$plugin]['account_settings_modules'])) {
                ...
                foreach ($mods as $mod) {
                    if ($mod['href'] == $module) {
                        ...
                        if (file_exists($pdir . '/account_settings/' . $module . '.js')) {
                            apiDie(
                                file_get_contents($pdir . '/account_settings/' . $module . '.js'),
                                200,
                                'text/javascript;charset=UTF-8'
                            );
                        } elseif (file_exists($pdir . '/account_settings/' . $module . '/' . $api_method . '.php')) {
